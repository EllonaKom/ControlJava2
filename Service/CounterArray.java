...
public class CounterArray {
    ...
    /**
     *
     * @param strArray переданный массив для создания класса подсчета количества слов и самого длинного слова
     */
    ...
    /**
     * Предоставляет значение длины самого длинного слова
     * @return
     */
    ...
    public String toString() {
        return  "Длина самого длинного слова: " + lengthLongestWord +
